...
class NoExistsResidue(ValueError):
    """ Checks if residue is in the protein residues list. If it's not, this error will be raised"""
    def __init__(self, residue):
        self.residue= residue        
    def __str__(self):
        return "%s is not found in the aminoacids dictionary" %(self.residue)
class NoExistsDesoxiribonucleotide(ValueError):
    """ Checks if nucleotide is in the DNA dictionary. If it's not this error will be raised"""
...
class NoExistsRibonucleotide(ValueError):
    """Checks if nucleotide is in the RNA dictionary. If it's not this error will be raised """
