import folder.utilities as utilities
import Bio.PDB
import copy
import os
import sys
...
def get_common_residues (chainA, chainB):
    '''This function returns a list of common residues (residues with CA or P atoms) between 2 chains objects'''
